...
<script type="text/javascript">
	...
	function save() {
		$.hh.validation.check('form', function(formData) {
			Request.request('system-OperLog-save', {
				data : formData,
	...
	function findData() {
		if (objectid) {
			Request.request('system-OperLog-findObjectById', {
				data : {
					id : objectid
				},
				callback : function(result) {
	...
	<div xtype="hh_content">
		<form id="form" xtype="form">
			...
			<table xtype="form">
					...
					<tr>
						<td xtype="label">message：</td>
						<td><span xtype="text" config=" name : 'message' "></span></td>
					</tr>
